...
{
  ackermann_msgs__msg__AckermannDriveStamped * msg = (ackermann_msgs__msg__AckermannDriveStamped *)malloc(sizeof(ackermann_msgs__msg__AckermannDriveStamped));
  if (!msg) {
    return NULL;
  }
...
ackermann_msgs__msg__AckermannDriveStamped__Sequence__init(ackermann_msgs__msg__AckermannDriveStamped__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (ackermann_msgs__msg__AckermannDriveStamped *)calloc(size, sizeof(ackermann_msgs__msg__AckermannDriveStamped));
    if (!data) {
      return false;
    }
...
{
  ackermann_msgs__msg__AckermannDriveStamped__Sequence * array = (ackermann_msgs__msg__AckermannDriveStamped__Sequence *)malloc(sizeof(ackermann_msgs__msg__AckermannDriveStamped__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  ackermann_msgs__msg__AckermannDriveStamped__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    ackermann_msgs__msg__AckermannDriveStamped * data =
      (ackermann_msgs__msg__AckermannDriveStamped *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ackermann_msgs__msg__AckermannDriveStamped__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          ackermann_msgs__msg__AckermannDriveStamped__fini(&data[i]);
        }
        free(data);
        return false;
      }
